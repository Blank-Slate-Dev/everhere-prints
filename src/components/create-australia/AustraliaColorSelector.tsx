// src/components/create-australia/AustraliaColorSelector.tsx
"use client";

import { motion } from "framer-motion";
import Image from "next/image";
import { Check } from "lucide-react";
import { australiaMapColors, AustraliaMapColor } from "@/lib/australiaMapConfig";

interface AustraliaColorSelectorProps {
  selectedColorId: string;
  onColorChange: (colorId: string) => void;
}

export default function AustraliaColorSelector({
  selectedColorId,
  onColorChange,
}: AustraliaColorSelectorProps) {
  return (
...
export function AustraliaColorPreviewExpanded({
  selectedColorId,
  onColorChange,
}: AustraliaColorSelectorProps) {
  return (
