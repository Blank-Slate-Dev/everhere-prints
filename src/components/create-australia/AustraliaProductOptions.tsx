// src/components/create-australia/AustraliaProductOptions.tsx
"use client";
...
interface AustraliaProductOptionsProps {
...
export default function AustraliaProductOptions({
  selectedSize,
  selectedFrame,
  onSizeChange,
  onFrameChange,
}: AustraliaProductOptionsProps) {
