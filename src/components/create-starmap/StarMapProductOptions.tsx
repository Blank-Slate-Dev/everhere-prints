// src/components/create-starmap/StarMapProductOptions.tsx
"use client";
...
interface StarMapProductOptionsProps {
...
export default function StarMapProductOptions({
  selectedSize,
  selectedFrame,
  onSizeChange,
  onFrameChange,
}: StarMapProductOptionsProps) {
