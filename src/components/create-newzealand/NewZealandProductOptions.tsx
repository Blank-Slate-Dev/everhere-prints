// src/components/create-newzealand/NewZealandProductOptions.tsx
"use client";
...
interface NewZealandProductOptionsProps {
...
export default function NewZealandProductOptions({
  selectedSize,
  selectedFrame,
  onSizeChange,
  onFrameChange,
}: NewZealandProductOptionsProps) {
