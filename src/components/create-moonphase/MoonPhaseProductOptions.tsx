// src/components/create-moonphase/MoonPhaseProductOptions.tsx
"use client";
...
interface MoonPhaseProductOptionsProps {
...
export default function MoonPhaseProductOptions({
  selectedSize,
  selectedFrame,
  onSizeChange,
  onFrameChange,
}: MoonPhaseProductOptionsProps) {
