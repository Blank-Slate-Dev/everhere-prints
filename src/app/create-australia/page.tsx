      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        >
          <h1 className="text-3xl lg:text-4xl font-serif font-semibold text-charcoal">
            Create Your Australia Map Print
          </h1>
          <p className="mt-3 text-brand-600 max-w-xl mx-auto">
            Mark your special place on a beautiful watercolour map of Australia.
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          >
            <AustraliaPrintPreview customization={customization} product={product} />
          </motion.div>
